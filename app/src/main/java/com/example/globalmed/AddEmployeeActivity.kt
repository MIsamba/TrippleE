...
import com.example.globalmed.DatabaseHelper
import com.example.globalmed.GlobalMedDBContract
...
class AddEmployeeActivity : Activity() {
    ...
    private fun saveEmployee() {
        ...
        values.put(GlobalMedDBContract.EmployeeEntry.COLUMN_NAME, name)
        values.put(GlobalMedDBContract.EmployeeEntry.COLUMN_DESIGNATION, designation)
        values.put(GlobalMedDBContract.EmployeeEntry.COLUMN_DOB, dob)

        val result = db.insert(GlobalMedDBContract.EmployeeEntry.TABLE_NAME, null, values)
